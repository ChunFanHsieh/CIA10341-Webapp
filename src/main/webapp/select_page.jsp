...
<table id="table-1">
   <tr><td><h3>IBM Specialty: Home</h3><h4>( MVC )</h4></td></tr>
</table>

<p>This is the Home page for IBM Specialty: Home</p>
...
<ul>
  ...
  <li>
     <FORM METHOD="post" ACTION="${pageContext.request.contextPath}/back-end/specialty/specialty.do">
       <b>選擇占卜項目編號:</b>
